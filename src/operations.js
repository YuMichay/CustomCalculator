...
export const percent = (firstOperand) => !Number.isInteger(formatNumber(firstOperand)) && firstOperand.length > 4 && firstOperand < 1 ? 'Number is too small' : formatNumber(firstOperand / 100);
...
export const factorial = (firstOperand, secondOperand) => {
  ...
  if (!Number.isInteger(formatNumber(firstOperand))) {
